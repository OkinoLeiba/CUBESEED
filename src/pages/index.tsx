...
import ServiceForm from "@/component/forms/service-form";
...
import UserDetailsForm from "@/component/forms/user-details-form";
      ...
      <section>
        ...
        <section className={homeStyles.home}>
          {/* <form onSubmit={handleSubmit}> */}
            ...
            {/* why do you need a progress bar and indictor of current form */}
            {!isLastStep ? (
              <button
                type="button"
                onClick={next}
